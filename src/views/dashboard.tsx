...
export default function Dashboard() {
  ...
  // Fallback: use authUser.auraScore if API aura.total is 0
  const displayAuraTotal = aura.total || authUser?.auraScore || 0;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-4xl font-black text-slate-900 tracking-tight mb-1">{displayAuraTotal}</div>
