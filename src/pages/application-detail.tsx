...
export default function ApplicationDetail() {
  ...
  return (
    <div className="space-y-6 pb-20 animate-in fade-in duration-500">
      {/* Navigation */}
      <Button variant="ghost" className="mb-2 pl-0 hover:pl-2 transition-all" onClick={() => navigate('/applications')}>
        ...
        <CardContent className="p-6 sm:p-8">
          <div className="flex flex-col md:flex-row justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 self-start md:self-center">
              ...
              <Button onClick={() => navigate(`/messages?userId=${application.recruiterId}`)}>
