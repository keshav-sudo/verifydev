...
const ScrollStack = ({
  ...
  const setupLenis = useCallback(() => {
    if (useWindowScroll) {
      const lenis = new Lenis({
        ...
        // smoothWheel: true, // v1.x property, usually implied
        // touchMultiplier: 2,
        infinite: false,
        // wheelMultiplier: 1,
        lerp: 0.1,
  ...
  useLayoutEffect(() => {
    ...
    // We need to support the useWindowScroll case finding cards globally or scoped
    // The user code finds them relative to document if useWindowScroll is true
